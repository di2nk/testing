...
wget https://netzvps.herokuapp.com/vpn/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
wget https://netzvps.herokuapp.com/vpn/sstp.sh && chmod +x sstp.sh && screen -S sstp ./sstp.sh
wget https://netzvps.herokuapp.com/vpn/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
wget https://netzvps.herokuapp.com/vpn/ssr.sh && chmod +x ssr.sh
wget https://netzvps.herokuapp.com/vpn/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
wget https://netzvps.herokuapp.com/vpn/ins-vt.sh && chmod +x ins-vt.sh && sed -i -e 's/\r$//' ins-vt.sh && screen -S v2ray ./ins-vt.sh
wget https://netzvps.herokuapp.com/vpn/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
