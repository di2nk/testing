...
cd /usr/bin
wget -O addss "https://netzvps.herokuapp.com/vpn/addss.sh"
wget -O delss "https://netzvps.herokuapp.com/vpn/delss.sh"
wget -O cekss "https://netzvps.herokuapp.com/vpn/cekss.sh"
wget -O xp-ss "https://netzvps.herokuapp.com/vpn/xp-ss.sh"
wget -O renewss "https://netzvps.herokuapp.com/vpn/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xp-ss
